        ...
        rg_signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(namee) || TextUtils.isEmpty(emaill) || TextUtils.isEmpty(Password) || TextUtils.isEmpty(cPassword)) {
                    ...
                    rg_password.setError("Give Proper Password");
                    return;
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful() && task.getResult() != null) {
                            ...
                            if (imageURI != null) {
                                ...
                                imageuri = "https://firebasestorage.googleapis.com/v0/b/a-n-messenger.appspot.com/o/noprofile.jpg?alt=media&token=cf8ffeb0-4e43-4a57-973b-b56b96998b00";
                                Users users = new Users(id, namee, emaill, Password, imageuri, status);
                                reference.setValue(users).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    @Override
                                    public void onComplete(@NonNull Task<Void> task) {
